...
### create HTML report with code coverage details

> [!Tip]
> use [reportgenerator](https://www.nuget.org/packages/dotnet-reportgenerator-globaltool) to generate code coverage reports from the cobertura xml files generated by coverlet. You can specify multiple report types to generate different formats of the report, such as HTML, Cobertura, and Markdown. The following command generates an HTML report with inline styles for Azure Pipelines, a Cobertura XML report, and a Markdown report in the specified target directory.
>
> ```shell
> dotnet test --project test\BranchIssues.Tests\BranchIssues.Tests.csproj --report-xunit-trx --framework net10.0 --verbosity normal --coverlet --coverlet-output-format cobertura --diagnostic --diagnostic-verbosity trace --results-directory artifacts/results --diagnostic-file-prefix BranchIssues
...
>
> ```shell
> dotnet exec artifacts\bin\XUnitProject1.Tests\debug_net10.0\XUnitProject1.Tests.dll --coverlet --coverlet-output-format teamcity --coverlet-output-format cobertura  --diagnostic --diagnostic-verbosity trace --diagnostic-output-directory artifacts\results\ --diagnostic-file-prefix XUnitProject1.Tests
> ```
>
> ```text
> xUnit.net v3 Microsoft.Testing.Platform v2 Runner v3.2.2+728c1dce01 (64-bit .NET 10.0.7)
>
> Diagnostic file (level 'Trace' with async flush): C:\GitHub\coverlet-examples\artifacts\results\XUnitProject1.Tests_260508071134333.diag
> Diagnostic file (level 'Trace' with async flush): C:\GitHub\coverlet-examples\artifacts\results\XUnitProject1.Tests_260508071136312.diag
>
> Test run summary: Passed! - artifacts\bin\XUnitProject1.Tests\debug_net10.0\XUnitProject1.Tests.dll (net10.0|x64)
>  total: 55
>  failed: 0
>  succeeded: 55
>  skipped: 0
...
>    - C:\GitHub\coverlet-examples\artifacts\bin\XUnitProject1.Tests\debug_net10.0\TestResults\coverage.cobertura.080526071137035.xml
>
>
> +---------------+--------+--------+--------+
> | Module        | Line   | Branch | Method |
> +---------------+--------+--------+--------+
> | ClassLibrary1 | 89.32% | 79.68% | 93.1%  |
> +---------------+--------+--------+--------+
>
> +---------+--------+--------+--------+
> |         | Line   | Branch | Method |
> +---------+--------+--------+--------+
> | Total   | 89.32% | 79.68% | 93.1%  |
> +---------+--------+--------+--------+
> | Average | 89.32% | 79.68% | 93.1%  |
> +---------+--------+--------+--------+
>
>
> ##teamcity[buildStatisticValue key='CodeCoverageAbsLCovered' value='159']
> ##teamcity[buildStatisticValue key='CodeCoverageAbsLTotal' value='178']
> ##teamcity[buildStatisticValue key='CodeCoverageAbsBCovered' value='51']
...
> ##teamcity[buildStatisticValue key='CodeCoverageAbsMTotal' value='29']
